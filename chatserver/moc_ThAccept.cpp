...
struct qt_meta_stringdata_ThAccept_t {
    QByteArrayData data[3];
    char stringdata[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ThAccept_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ThAccept_t qt_meta_stringdata_ThAccept = {
    {
QT_MOC_LITERAL(0, 0, 8),
QT_MOC_LITERAL(1, 9, 7),
QT_MOC_LITERAL(2, 17, 0)
    },
    "ThAccept\0sigInfo\0\0"
};
...
void ThAccept::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThAccept::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThAccept::sigInfo)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ThAccept::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThAccept.data,
      qt_meta_data_ThAccept,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThAccept.stringdata))
